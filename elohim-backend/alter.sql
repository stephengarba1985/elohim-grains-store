...
ALTER TABLE users ADD COLUMN IF NOT EXISTS authorization_code VARCHAR(255);
...
ADD COLUMN IF NOT EXISTS rating NUMERIC(3,2) DEFAULT 5,
ADD COLUMN IF NOT EXISTS completed_deliveries INT DEFAULT 0,
ADD COLUMN IF NOT EXISTS cancelled_deliveries INT DEFAULT 0,
ADD COLUMN IF NOT EXISTS earnings NUMERIC(12,2) DEFAULT 0,
