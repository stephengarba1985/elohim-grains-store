...
const STATIC_GRAIN_ASSET_PATHS = {
  ...
  "meat": "/grains/Meat.png",
  "meat product": "/grains/Meat.png",
  "meat products": "/grains/Meat.png",
  "poultry": "/grains/Poultry.jpg",
  "poultry product": "/grains/Poultry.jpg",
  "poultry products": "/grains/Poultry.jpg",
  "fresh table eggs": "/grains/Eggs.jpeg",
  "fresh table egg": "/grains/Eggs.jpeg",
  "fresh table eggs product": "/grains/Eggs.jpeg",
  "table eggs": "/grains/Eggs.jpeg",
  "eggs": "/grains/Eggs.jpeg",
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              href={`https://wa.me/2348039688939?text=${encodeURIComponent(`Hello Elohim Grains, I have a question about ${product.name}${selectedVariant?.weight || selectedType?.name || product.weight ? ` (${selectedVariant?.weight || selectedType?.name || product.weight})` : ""} — ${formatPrice(price)}.`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-center text-sm font-semibold text-slate-700 hover:text-emerald-700 hover:underline"
            >
